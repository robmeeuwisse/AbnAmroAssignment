...
fun RepoItem(
    ...
    Row(
        ...
        val visibilityRes = when (repo.visibility) {
            Repo.Visibility.Public -> R.string.repo_visibility_public
            Repo.Visibility.Private -> R.string.repo_visibility_private
            Repo.Visibility.Unknown -> null
        }
        if (visibilityRes != null) {
            Label(stringResource(visibilityRes))
        }
    }
}
